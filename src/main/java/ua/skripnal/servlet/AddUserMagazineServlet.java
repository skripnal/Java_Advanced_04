...
@WebServlet("/addUserMagazineServlet")
public class AddUserMagazineServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (user.getBalance()>=magazine.getPrice()){
            user.addMagazineFromUser(magazine);
        }
